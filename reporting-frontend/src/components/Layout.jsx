...
const Layout = ({ children, user, onLogout, currentPage, onNavigate, permissions = [], accessibleDepartments = [] }) => {
  ...
  const desiredOrder = ['dashboard', 'vital-case-data', 'vital-financial', 'vital-marketing', 'vital-hubspot', 'vital-quickbooks', 'vital-azure-sql', 'parts', 'service', 'rental', 'accounting', 'knowledge-base', 'financial', 'qbr', 'my-commissions', 'minitrac', 'database-explorer', 'schema-explorer', 'rep-comp-admin', 'tenant-admin', 'vital-data-sources', 'user-management']
