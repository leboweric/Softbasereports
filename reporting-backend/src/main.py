...
from src.routes.vital_sales_dashboard import vital_sales_dashboard_bp
...
from src.routes.vital_claude_analytics import vital_claude_analytics_bp
...
app.register_blueprint(vital_sales_dashboard_bp)
...
app.register_blueprint(vital_claude_analytics_bp)
